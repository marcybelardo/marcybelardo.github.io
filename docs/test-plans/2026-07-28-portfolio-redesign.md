...
2. Use keyboard only to test header destinations, menu open/Escape/focus return, project and contact links, tag links, footnotes, and migration fallback links.
