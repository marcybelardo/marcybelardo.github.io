...
The Blog and tag headings, entry titles, article titles, and About title use the shared `--font-display` compressed sans stack. Blog article copy stays in the serif reading face, while dates, tags, and other utility metadata keep regular sans.
