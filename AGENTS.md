...
Margin-note cleanup retains each note's original parent/index and neighboring nodes independently of its placeholder, falls back to the visible endnote list when needed, and has stylesheet-backed narrow/print visibility regression coverage.
